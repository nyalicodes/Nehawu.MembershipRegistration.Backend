...
using Moq;
using NSubstitute;
using Nehawu.MembershipRegistration.Backend.Tests.DependencyInjection;
using Shesha;
using Shesha.Configuration.Runtime;
using Shesha.NHibernate;
using Shesha.Services;

namespace Nehawu.MembershipRegistration.Backend.Tests
{
    [DependsOn(
    ...
    public class ShaProjectNameTestModule : AbpModule
    {
        private const string ConnectionString = @"Data Source=.;Initial Catalog=DsdNpo;Integrated Security=True";

        public ShaProjectNameTestModule(SheshaNHibernateModule nhModule)
        {
