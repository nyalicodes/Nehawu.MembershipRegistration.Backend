...
using Abp.PlugIns;
using Nehawu.MembershipRegistration.Backend.Swagger;
...
using Nehawu.MembershipRegistration.Backend.Web.Host.Swagger;
using Microsoft.Extensions.Options;
using Swashbuckle.AspNetCore.SwaggerGen;
using Microsoft.AspNetCore.Mvc.ApplicationModels;
using Microsoft.Extensions.DependencyInjection.Extensions;

namespace Nehawu.MembershipRegistration.Backend.Web.Host.Startup
{
        ...
        public void Configure(IApplicationBuilder app, IBackgroundJobClient backgroundJobs)
        {
            ...
            app.UseSwaggerUI(options =>
            {
                ...
                options.IndexStream = () => Assembly.GetExecutingAssembly()
                    .GetManifestResourceStream("Nehawu.MembershipRegistration.Backend.Web.Host.wwwroot.swagger.ui.index.html");
            }); // URL: /swagger
