...
{
    /// <summary>
    /// ShaProjectName Authorization Provider
    /// </summary>
    public class ShaProjectNameAuthorizationProvider : AuthorizationProvider
    {
        /// <summary>
        ...
        {
            return new LocalizableString(name, "ShaProjectName");
        }
    }
}
